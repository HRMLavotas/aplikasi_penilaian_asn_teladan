  ...
  const fetchExistingEvaluation = async () => {
    try {
      ...
      if (data) {
        ...
        berorientasi_pelayanan_score: data.kinerja_perilaku_score || 70,
        akuntabel_score: data.inovasi_dampak_score || 70,
        kompeten_score: data.inspiratif_score || 70,
        harmonis_score: data.komunikasi_score || 70,
        loyal_score: data.kerjasama_kolaborasi_score || 70,
        adaptif_score: data.leadership_score || 70,
        kolaboratif_score: data.rekam_jejak_score || 70,
